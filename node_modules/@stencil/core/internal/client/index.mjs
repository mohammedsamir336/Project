/*
 Stencil Client Platform v1.9.0-14 | MIT Licensed | https://stenciljs.com
 */
...
const patchEsm = () => {
    ...
    if (BUILD.cssVarShim && !(win.CSS && win.CSS.supports && win.CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return import(/* webpackChunkName: "stencil-polyfills-css-shim" */ './css-shim.mjs').then(() => {
...
const patchBrowser = () => {
    ...
    if (importMeta !== '') {
        ...
        if (!window.customElements) {
            ...
            // @ts-ignore
            return import(/* webpackChunkName: "stencil-polyfills-dom" */ './dom.mjs').then(() => opts);
        }
    }
