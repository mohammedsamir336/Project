import { BuildEmitEvents, BuildEvents, BuildLog, BuildOnEvents, BuildOutput, CompilerBuildResults, CompilerBuildStart, CompilerFsStats, CompilerSystem, Config, CopyResults, DevServerConfig, DevServerEditor, Diagnostic, FileSystem, FsWatcher, FsWriteOptions, HotModuleReplacement, Logger, LoggerTimeSpan, OptimizeCssInput, OptimizeCssOutput, OutputTargetWww, PageReloadStrategy, PrerenderRequest, PrerenderResults, StencilSystem } from './stencil-public-compiler';
...
export declare type CompileScript = 'latest' | 'esnext' | 'es2017' | 'es2015' | 'es5' | string | undefined;
