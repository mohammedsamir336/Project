/*
 Stencil Hydrate Platform v1.9.0-14 | MIT Licensed | https://stenciljs.com
 */
export { BUILD, NAMESPACE } from '@stencil/core/internal/app-data';
import { parsePropertyValue, getValue, setValue, connectedCallback, insertVdomAnnotations } from '@stencil/core/internal/runtime';
