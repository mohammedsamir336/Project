 ...
 */
import { plt, doc, win, supportsListenerOptions, getHostRef, styles, supportsConstructibleStylesheets, supportsShadowDom, consoleDevError, consoleDevWarn, isMemberInElement, consoleError, nextTick, writeTask, loadModule, registerHost, forceUpdate as forceUpdate$1, Context, readTask } from '@stencil/core/internal/platform';
    ...
    if ((BUILD.lazyLoad || BUILD.hydrateServerSide || BUILD.style) && (hostRef.$flags$ & 32 /* hasInitializedComponent */) === 0) {
        ...
        if (BUILD.style && !styles.has(scopeId) && Cstr.style) {
            ...
            if (!BUILD.hydrateServerSide && BUILD.shadowDom && cmpMeta.$flags$ & 8 /* needsShadowDomShim */) {
                style = await import('./shadow-css.mjs').then(m => m.scopeCss(style, scopeId, false));
            }
...
export { Host, attachShadow, bootstrapLazy, connectedCallback, createEvent, defineCustomElement, disconnectedCallback, forceModeUpdate, forceUpdate, getAssetPath, getConnect, getContext, getElement, getMode, getRenderingRef, getValue, h, insertVdomAnnotations, parsePropertyValue, postUpdateComponent, proxyComponent, proxyCustomElement, renderVdom, setMode, setValue };
