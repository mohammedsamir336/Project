...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title"><u>Admins Blocked</u> (<?php echo e($count); ?>)</h5>
                    ...
                    <?php $__currentLoopData = $admins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      ...
                      <!--profile-->
                  <td> <span class="table-remove"><a href="<?php echo e(url('admin/profile  '.$data->id)); ?>"
               ...
               <!--AddBY-->
                ...
                <!--Time-->
                <td><nobr><?php echo e(now()->diffForHumans($data->blocked_date)); ?> Unblocked</nobr></td>
                ...
                <!--check if super admins-->
                       ...
                       <!--actives admins-->
                    <td>
                      <form class="" action="<?php echo e(url('/admin/adminsactive')); ?><?php echo e($data->id); ?>" method="post">
                         <?php echo csrf_field(); ?>
                          <div >
...
<?php /**PATH C:\xampp\htdocs\Project\resources\views\admin\admins_table\Blocked.blade.php ENDPATH**/ ?>