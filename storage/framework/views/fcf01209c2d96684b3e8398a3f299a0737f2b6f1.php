...
<div class="container">
      ...
      <section class="my-5">
        ...
        <div class="row">
          ...
          <!-- Grid column -->
          <div class="col-lg-8">
            <form enctype="multipart/form-data" action="<?php echo e(route('admin.NewVideoInPost')); ?>" method="post">
                     <?php echo csrf_field(); ?>
            <!-- if post have video-->
           ...
           <!--  card -->
            ...
            <div class="card mb-4 post-title-panel">
              <div class="card-body">
                <div class="md-form mt-1 mb-0">
                  <input type="url" name="video" id="form4" class="form-control" value="<?php echo e(old('video')); ?>" required>
            ...
            <div class="card mb-4 post-title-panel">
              <div class="card-body">
                <div class="md-form mt-1 mb-0">
                  <input type="text" name="title" id="video_title" class="form-control" value="<?php echo e(old('title')); ?>" required>
...
<?php /**PATH C:\xampp\htdocs\Project\resources\views\admin\videos\NewVideoInPost.blade.php ENDPATH**/ ?>