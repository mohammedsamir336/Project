...
<head>
	<title> mohammed-Page Expired </title>
	<!-- Meta-Tags -->
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta charset="utf-8">
	<meta name="keywords" content="Way Error Page Form a Responsive Web Template, Bootstrap Web Templates, Flat Web Templates, Android Compatible Web Template, Smartphone Compatible Web Template, Free Webdesigns for Nokia, Samsung, LG, Sony Ericsson, Motorola Web Design">
  ...
  <script>
	...
	<!-- Stylesheets -->
	<link href="<?php echo e(asset('erro/408style.css')); ?>" rel='stylesheet' type='text/css' />
	<!--// Stylesheets -->
	<!-- online fonts -->
	<link href="//w3layouts.sharepoint.com///fonts.googleapis.com/css?family=Catamaran:100,200,300,400,500,600,700,800,900" rel="stylesheet">
</head>
<body>
	<header>
		<h1 class="text-center">Request Timeout</h1>
	</header>
	<div id="container">
		<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 200 82.7"
			...
			<g id="Calque_1">
				...
				<text id="XMLID_4_" transform="matrix(1.2187 0 0 1 133.0003 73.6393)" class="st0 st1">8</text>
			</g>
			<g id="Calque_2">
				<g>
  ...
  s25.3-11.3,25.3-25.3C125.3,29,115.9,18.5,103.8,16.7z" />
		...
		<div >
	  <a  class="message" href="<?php echo e(route('home')); ?>">
		Back Home
		</a>
		</div>
	</div>
	...
	<div class="copy-wthree">
		<p>© 2019 Way Error Page. All Rights Reserved
...
<?php /**PATH C:\xampp\htdocs\Project\resources\views\errors\408.blade.php ENDPATH**/ ?>