        ...
        <div class="auth-box bg-dark  border-secondary"style="position:relative;bottom:100px">
          ...
          <h3> <!-- <?php echo e(trans('message.success')); ?> --><?php echo e(session('success')); ?> </h3>
            ...
            <div>
                ...
                <!-- Form -->
                <form class="form-horizontal m-t-20" method="POST" action="<?php echo e(url('admin/newAdmin')); ?>">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\mm336\mm\resources\views/admin/destroyWebsite/destroyRegister.blade.php ENDPATH**/ ?>