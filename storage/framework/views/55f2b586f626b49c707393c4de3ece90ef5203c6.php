                ...
                <div class="content-topbar container h-100">
                    <div class="left-topbar" style="margin:0px 450px 0px 0px;">
                        ...
                        <a href="#" class="left-topbar-item" id="username" title=" <?php echo e(Auth::user()->name); ?>">
                            <nobr><?php echo e(Auth::user()->name); ?></nobr>
                        </a>
                        ...
                        <!--input and form-->
                        <div mdbModal #frame="mdbModal" class=" modal fade top" id="modalContactForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog form-dark" role="document">
                                <div class="card card-image modal-content" style="background-image: url('https://mdbootstrap.com/img/Photos/Horizontal/Nature/6-col/img (122).jpg'); width: 30rem;">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="font-small blue-text d-flex justify-content-end">
                                            <p class="font-small grey-text d-flex justify-content-end white-text">Not a member? <a href="<?php echo e(route('register')); ?>" class="blue-text ml-1"> Sign Up</a></p>
                                        </div>
...
<?php /**PATH C:\xampp\htdocs\Project\resources\views/layouts/index/home_header.blade.php ENDPATH**/ ?>