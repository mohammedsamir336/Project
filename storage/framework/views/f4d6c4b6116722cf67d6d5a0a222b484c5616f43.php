  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger text-default" href="<?php echo e(route('logout')); ?>"
...
unset($__errorArgs, $__bag); ?>" name="code" value="<?php echo e(old('code')); ?>"  placeholder="<?php echo e(__('Phone verfiy')); ?>" required autocomplete="code" autofocus >

                      <?php if(session('error')): ?>
                        <div class="alert alert-danger" role="alert">
                      <strong> <!-- <?php echo e(trans('message.success')); ?> --><?php echo e(session('error')); ?> <strong>
                       </div>
