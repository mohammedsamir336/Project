...
<div class="container">
      ...
      <section class="my-5">
        ...
        <div class="row">
          ...
          <div class="col-lg-8">
            ...
            <form enctype="multipart/form-data" action="<?php echo e(route('admin.NewVideoPost')); ?>" method="Post">
                     <?php echo csrf_field(); ?>
            <!--  card -->
      ...
      <textarea id="drive-demo" name="p1" required><?php echo e(old('p1')); ?></textarea>
            </div>
            <!--  card -->
            <div class="card mb-4">
          ...
          <p class="text-muted ml-4 mt-2"><small> photo will be changed automatically</small></p>
                ...
                <i class="fas fa-cloud-upload-alt mr-2" aria-hidden="true"></i>
                  <input  type="file" name="select_file" id="select_file" onchange="readURL(this);" multiple required>
                     ...
                     <h4> <!-- <?php echo e(trans('message.success')); ?> --><?php echo e(session('errors')); ?> </h4>
...
<?php /**PATH C:\xampp\htdocs\Project\resources\views\admin\posts\CreatePostWithVideo.blade.php ENDPATH**/ ?>