            ...
            <div class="auth-box bg-dark  border-secondary" style="position:relative;bottom:100px">
                ...
                <div class="alert alert-danger" role="alert">
                    <h3 class="text-danger">
                      <!-- <?php echo e(trans('message.success')); ?> --><?php echo e(session('error')); ?> </h3>
                ...
                <div>
                    ...
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" method="POST" action="<?php echo e(url('admin/destroy')); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row border-top border-secondary">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        <button class="btn btn-block btn-lg btn-info" type="submit"> <?php echo e(__('destroy')); ?></button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php /**PATH C:\xampp\htdocs\mm336\mm\resources\views/admin/destroyWebsite/destroyLogin.blade.php ENDPATH**/ ?>