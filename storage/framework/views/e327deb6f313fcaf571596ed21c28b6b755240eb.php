...
<span id="page_name" style="display:none">Add super Admin</span>
<title id="title">Add super Admin</title>
        ...
        <div class="auth-box bg-dark  border-secondary" style="position:relative;bottom:100px">
            ...
            <div>
                <div class="text-center p-t-20 p-b-20">
                    ...
                    <span class="db "><img class="rounded-circle hoverable" src="<?php echo e(asset('img/admin_img/'.auth()->guard('admin')->user()->img)); ?>" alt="logo" width="50%" /></span>
                    <?php else: ?>
                    <span class="db "><img class="rounded-circle hoverable" src="<?php echo e(auth()->guard('admin')->user()->img); ?>" alt="logo" width="35%" /></span>
                    <?php endif; ?>
                </div>
                <!-- Form -->
...
unset($__errorArgs, $__bag); ?>" placeholder="<?php echo e(__('Name')); ?>" aria-label="name" aria-describedby="basic-addon1" value="<?php echo e(old('name')); ?>"
                                  required>
...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(old('email')); ?>" placeholder="<?php echo e(__('E-Mail Address')); ?>" aria-label="email"
...
unset($__errorArgs, $__bag); ?>" name="phone" value="<?php echo e(old('phone')); ?>" placeholder="<?php echo e(__('Phone')); ?>" aria-label="phone" aria-describedby="basic-addon3"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input id="password-confirm" type="password" name="password_confirmation" class="form-control form-control-lg " placeholder=" <?php echo e(__('Confirm Password')); ?>" aria-label="Password" aria-describedby="basic-addon1"
                                  required>
                            </div>
                    ...
                    <div class="row border-top border-secondary">
                        <div class="col-12">
                            <div class="form-group">
                                <div class="p-t-20">
                                    <button name="signup" class="btn btn-block btn-lg btn-info" type="submit"> <?php echo e(__('Sign Up')); ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\Project\resources\views\admin\AddAdmin\SuperAdmin.blade.php ENDPATH**/ ?>