        ...
        <div class="tab-pane p-20" id="photo" role="tabpanel">
            <div class="p-20">
              ...
              <div class="col-lg-4 mb-4" style="margin-left:30px">
                ...
                <img  id="admin_img" src="<?php echo e(asset('img/admin_img/'.auth()->guard('admin')->user()->img)); ?>" class=" rounded-circle hoverable" height="230" width="250" />
                 <?php else: ?>
                 <img  id="admin_img" src="<?php echo e(auth()->guard('admin')->user()->img); ?>" class=" rounded-circle hoverable" height="170" width="190" />
                 <?php endif; ?>
...
<!-- Card -->
    <div class="tab-pane p-20" id="profile" role="tabpanel">
        ...
        <div  style="margin-left:30px">
                ...
                <!-- Edit Form -->
          <form action="<?php echo e(route('admin.change_profile')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                  <!-- First row -->
...
unset($__errorArgs, $__bag); ?>" name="birth" value="<?php echo e(old('birth')); ?>"
                         placeholder="<?php echo e(__('Birth Date')); ?>" onfocus="(this.type='date')"
...
unset($__errorArgs, $__bag); ?>" name="website" value="<?php echo e(old('website')); ?>"
                        placeholder="<?php echo e(__('Website Address')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="facebook" value="<?php echo e(old('facebook')); ?>"
                        placeholder="<?php echo e(__('Facebook Address')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="phone" value="<?php echo e(old('phone')); ?>"
                        placeholder="<?php echo e(__('Phone number')); ?>" onfocus="(this.type='number')"
...
<?php /**PATH C:\xampp\htdocs\Project\resources\views\admin\setting.blade.php ENDPATH**/ ?>