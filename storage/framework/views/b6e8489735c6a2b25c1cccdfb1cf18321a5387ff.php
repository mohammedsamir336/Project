...
<span id="page_name" style="display:none">Create Videos</span>
<title id="title">Create Videos</title>
      ...
      <section class="my-5">
        ...
        <div class="row">
          ...
          <div class="col-lg-8">
            ...
            <form enctype="multipart/form-data" action="<?php echo e(route('admin.NewVideo')); ?>" method="post">
                     <?php echo csrf_field(); ?>
        ...
        <!-- Card content -->
          ...
          <!-- Grid column -->
          <div class="mt-4">
            <button type="submit" class="btn btn-lg btn-block btn-outline-info" id="send">Create Video</button>
          </div>
          </form>
...
<?php /**PATH C:\xampp\htdocs\Project\resources\views\admin\videos\NewVideo.blade.php ENDPATH**/ ?>