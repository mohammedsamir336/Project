        ...
        <ul class="list-style-none">
            ...
            <li class="d-flex no-block card-body">
                ...
                <div>
                    ...
                    <span class="text-muted ml-4" style="position:relative;left:10px"><?php echo e(Str::words($data->text, 5, '...')); ?></span>
                    <!--Str::limit($data->text, 30, '...')-->

                    <div id="collapseTwo<?php echo e($data->id); ?>" class="collapse" aria-labelledby="headingTwo<?php echo e($data->id); ?>">
                        <div class="card-body">
                            <span><a href="#" class="text-dark"> By: <b><?php echo e($data->news_admins_id()->first()->name); ?></b></a></span>
...
<?php /**PATH C:\xampp\htdocs\Project\resources\views/admin/layout/News.blade.php ENDPATH**/ ?>