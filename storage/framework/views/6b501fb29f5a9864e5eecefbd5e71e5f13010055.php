...
<body>
    ...
    <div id="main-wrapper">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <a id="nav_img" class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img id="navimg"
                                  src="<?php echo e(asset('img/admin_img/'.Auth::guard('admin')->user()->img)); ?>" alt="admin" class="rounded-circle" height="51" width="51"></a>
                            <?php else: ?>
                            <a id="nav_img" class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img id="navimg"
                                  src="<?php echo e(Auth::guard('admin')->user()->img); ?>" alt="admin" class="rounded-circle" height="51" width="51"></a>
                            <?php endif; ?>
        ...
        <div class="page-wrapper">
            ...
            <!-- ============================================================== -->
            <!-- ============================================================== -->
<?php /**PATH C:\xampp\htdocs\mm336\mm\resources\views/admin/layout/header.blade.php ENDPATH**/ ?>