...
<div class="card">
    ...
    <div class="comment-widgets scrollable" style="max-height: 130px;">
        ...
        <div class="d-flex flex-row comment-row m-t-0">
          ...
          <a href="<?php echo e(url('admin/profile  '.$data->id)); ?>"><h6 class="font-medium"><?php echo e($data->name); ?></h6></a>
...
<?php /**PATH C:\xampp\htdocs\mm336\mm\resources\views/admin/layout/partner.blade.php ENDPATH**/ ?>