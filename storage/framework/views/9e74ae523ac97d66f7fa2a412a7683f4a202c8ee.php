  ...
  <div class="container-fluid text-center mt-5" style="position:fixed;left:250px;">
      ...
      <div class="text-white text-center d-flex align-items-center rgba-black py-5 px-4">
        <div>
          ...
          <h3 class="card-title pt-2"><strong><?php echo e(__('Verify Your Email Address')); ?></strong></h3>
                <?php echo e(__('Admin Before proceeding, please check your email for a verification link.')); ?>
...
<!-- /background -->
<?php /**PATH C:\xampp\htdocs\mm336\mm\resources\views/admin/auth/verify.blade.php ENDPATH**/ ?>