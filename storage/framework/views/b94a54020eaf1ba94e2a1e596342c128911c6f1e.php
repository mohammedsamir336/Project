...
<!--if guest img-->
  ...
  <div class="msgw-Avatar msgw-Avatar--sm msgw-Avatar--black"><?php echo e(strtoupper(mb_substr(Auth::user()->name,0,1,'utf-8'))); ?></div>
      <!--<img class="card-img-64 rounded-circle z-depth-1 d-flex mx-auto mb-3" src="<?php echo e(asset('img/m.png')); ?>"
        alt="Generic placeholder image">-->
  <?php endif; ?>
...
<div class="md-form mt-4" id="rep<?php echo e($rep->reply_id); ?>"  style="display:none;">
     ...
     <?php endif; ?>
      <div class="media d-block d-md-flex mt-4" >
        ...
        <img class="card-img-64 rounded-circle z-depth-1 d-flex mx-auto mb-3" src="<?php echo e(asset('img/users_img/'.$rep->img)); ?>"
          ...
          <?php else: ?>
          <!--strtoupper() for Uppercase first letter and mb_substr for arabic name-->
        <div class="msgw-Avatar msgw-Avatar--sm msgw-Avatar--black"><?php echo e(strtoupper(mb_substr($rep->name,0,1,'utf-8'))); ?></div>
            <?php endif; ?>
  ...
  <?php if(auth()->guard('admin')->check()): ?>
  <a href="<?php echo e(url('del_reply'.$rep->reply_id)); ?>" class="text-default">Delete</a>
   <?php endif; ?>
...
<div class="media d-block d-md-flex mt-4" >
 ...
 <img class="card-img-64 rounded-circle z-depth-1 d-flex mx-auto mb-3" src="<?php echo e(asset('img/users_img/'.$re->RepUsers->img)); ?>"
   ...
   <?php else: ?>
   <!--strtoupper() for Uppercase first letter and mb_substr for arabic name-->
 <div class="msgw-Avatar msgw-Avatar--sm msgw-Avatar--black"><?php echo e(strtoupper(mb_substr($re->RepUsers->name,0,1,'utf-8'))); ?></div>
     <?php endif; ?>
 <div class="media-body text-center text-md-left ml-md-3 ml-0" >
   <h5 class="font-weight-bold mt-0">
