...
<head>
  ...
  <title>{{ config('app.name')}}-Page denied</title>
  ...
  <link href="{{ asset('css/mdb.min.css') }}" rel="stylesheet" type="text/css">
	<link type="text/css" rel="stylesheet" href="{{ asset('erro/403style.css') }}" />
...
.nn {
 ...
 width: 100%;
 height: 100%;
 background-image: url('{{asset('img/bbg.jpg')}}');
...
<body>
	...
	<div id="notfound">
      ...
      <p >Sorry.. You don't have authorization to view this page.</p>
			...
			<a href="{{route('home')}}" class="text-secondary ">Back To Homepage</a>
		</div>
	</div>
