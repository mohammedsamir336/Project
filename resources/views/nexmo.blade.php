                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input onKeyPress="if(this.value.length==4) return false;" id="code" type="number" class="form-control validate @error('code') is-invalid @enderror" name="code" value="{{ old('code') }}"
                                                  placeholder="{{ __('Phone verfiy') }}" required autocomplete="code" autofocus>
                                                @if (session('error'))
                                                <div class="alert alert-danger" role="alert">
                                                    <strong>
                                                        <!-- {{trans('message.success')}} -->{{ session('error') }} <strong>
                                                </div>
