                        ...
                        <table id="zero_config" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> <span class="table-remove"><a href="{{ url('admin/profile  '.$data->id) }}" class="btn btn-warning btn-rounded btn-sm my-0" target="_blank">profile</a></span>
                                    </td>
                                    ...
                                    <td>
                                        <form class="" action="{{ url('/admin/adminsblock') }}{{$data->id}}" method="post">
                                            ...
                                            <div class="md-form input-group mb-6">
                                                <input type="text" id="form81" class="form-control @error('block') is-invalid @enderror" name="block" value="{{old('block') }}" placeholder="{{ __('Block admin') }}" onfocus="(this.type='date')"
