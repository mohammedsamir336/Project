        ...
        <h3> <!-- {{trans('message.success')}} -->{{ session('success') }} </h3>
            ...
            <div class="card">
              ...
              @foreach ($posts as $data)
                      ...
                      <td><nobr><a href="{{url('read = '.$data->header)}}" class="text-info" target="_blank">{{$data->header}}</a></nobr></td>
                         ...
                         <td>
                           ...
                           <td> <nobr> <span class="table-remove"><a href="{{ url('admin/edit  '.$data->header) }}"
                                class="btn btn-warning btn-rounded btn-sm my-0" target="_blank">edit post</a></span>

                            <span class="table-remove"><a href="{{ url('admin/del'.$data->id.'del'.$data->videos_id) }}"
