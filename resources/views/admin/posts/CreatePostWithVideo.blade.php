...
<span id="page_name" style="display:none">posts With Video</span>
<title id="title">posts With Video </title>
...
<div class="container">
      ...
      <section class="my-5">
        ...
        <div class="row">
          ...
          <div class="col-lg-8">
            ...
            <form enctype="multipart/form-data" action="{{route('admin.NewVideoPost')}}" method="Post">
                     @csrf
            <!--  card -->
            <div class="card mb-4 post-title-panel">
              <div class="card-body">
                <div class="md-form mt-1 mb-0">
                  <input type="text" id="header" name="header" class="form-control " value="{{ old('header') }}" required>
            ...
            <div class="card mb-4 post-title-panel">
              <div class="card-body">
                <div class="md-form mt-1 mb-0">
                  <input type="text" name="tag" id="form3" class="form-control" value="{{ old('tag') }}" required>
      ...
      <textarea id="drive-demo" name="p1" required>{{ old('p1') }}</textarea>
            </div>
            <!--  card -->
            <div class="card mb-4">
               <span class="ml-2">p2</span>
          <textarea name="p2" >{{ old('p2') }}</textarea>
            </div>

            <!--  card -->
            <div class="card mb-4">
              <span class="ml-2">p3</span>
          <textarea name="p3" >{{ old('p3') }}</textarea>
            </div>
          ...
          <p class="text-muted ml-4 mt-2"><small> photo will be changed automatically</small></p>
                ...
                <i class="fas fa-cloud-upload-alt mr-2" aria-hidden="true"></i>
                  <input  type="file" name="select_file" id="select_file" onchange="readURL(this);" multiple required>
                     ...
                     <h4> <!-- {{trans('message.success')}} -->{{ session('errors') }} </h4>
