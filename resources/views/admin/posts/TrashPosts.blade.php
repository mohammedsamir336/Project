                            ...
                            <table id="zero_config" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <label class="customcheckbox" for="checkbox{{$data->id}}" onclick="if ($('#videocheckbox{{$data->id}}')
                                              .prop( 'checked', false )){
                                               $('#videocheckbox{{$data->id}}')
                                               .prop( 'checked', true )
                                               }else{$('#videocheckbox{{$data->id}}').prop( 'checked', false )};">
                                        ...
                                        <td>
                                            <nobr><span class="text-lightgray">{{$data->header}}</span></nobr>
                                        </td>
                                        ...
                                        <td>
                                            <nobr>{{$data->deleted_at->longAbsoluteDiffForHumans()}}</nobr>
                                        </td>

                                        <td>
                                            <nobr> <span class="table-remove"><a href="{{ url('admin/restore'.$data->id.'restore'.$data->videos_id) }}" class="btn btn-success btn-rounded btn-sm my-0">restore post</a></span>

                                                <span class="table-remove"><a href="{{ url('admin/forceDel'.$data->id.'forceDel'.$data->videos_id) }}" class="btn btn-danger btn-rounded btn-sm my-0" style="margin-left:10px;">Force Delete </a></span>
                                            </nobr>
                                        </td>
                                    </tr>
