...
<div class="container">
      ...
      <section class="my-5">
        ...
        <div class="row">
          ...
          <!-- Grid column -->
          <div class="col-lg-8">
            <form enctype="multipart/form-data" action="{{route('admin.NewVideoInPost')}}" method="post">
                     @csrf
            <!-- if post have video-->
            @if (session('errors'))

            <button type="button" id="confirm" class="btn btn-default btn-lg btn-block roster-button active" data-toggle="modal" data-target="#confirm_model" data-id="jsmith22" hidden>confirm</button>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    ...
                    <button  name="confirm" class="btn btn-danger"  type="submit" >Continue</button>
                  </div>
                </div>
                <!-- end modal-content -->
             </div>
           ...
           <!--  card -->
            ...
            <div class="card mb-4 post-title-panel">
              <div class="card-body">
                <div class="md-form mt-1 mb-0">
                  <input type="text" name="author" id="form2" class="form-control " value="{{ old('author') }}" required>
            ...
            <div class="card mb-4 post-title-panel">
              <div class="card-body">
                <div class="md-form mt-1 mb-0">
                  <input type="url" name="video" id="form4" class="form-control" value="{{ old('video') }}" required>
            ...
            <div class="card mb-4 post-title-panel">
              <div class="card-body">
                <div class="md-form mt-1 mb-0">
                  <input type="text" name="title" id="video_title" class="form-control" value="{{ old('title') }}" required>
              ...
              <!-- Card type -->
                    ...
                    <div class="card-body card-body-cascade" id="Entertainment" >
                      <fieldset class="form-check mb-4" id="typefield11">
                        <input  name="type" class="type form-check-input" checked value="Celebrity" type="checkbox" id="color-11">
        ...
        $(document).ready(function(){
         ...
         $('#video_title').blur(function(){
          ...
          if( !title)
          {
           ...
           $('#video_title').addClass('has-error');
           ...
           $.ajax({
            ...
            success:function(result)
            {
             if(result == 'unique')
             {
              ...
              $('#video_title').removeClass('has-error');
