...
<div class="container">
      ...
      <section class="my-5">
        ...
        <div class="row">
          ...
          <div class="col-lg-8">
            ...
            <form enctype="multipart/form-data" action="{{route('admin.uploadVideo')}}" method="post">
                     @csrf
            ...
            <div class="card mb-4 post-title-panel">
              <div class="card-body">
                <div class="md-form mt-1 mb-0">
                  <input type="text" name="author" id="form2" class="form-control " value="{{$video->author}}" required>
            ...
            <div class="card mb-4 post-title-panel">
              <div class="card-body">
                <div class="md-form mt-1 mb-0">
                  <input type="url" name="video" id="form4" class="form-control" value="{{$video->url}}" required>
      ...
      <input  id="test_title" type="hidden" name="titleTest" value="{{$video->title}}">
              </div>
            </div>
            <!--  card -->
            {!!$video->video!!}
              ...
              <!-- append Card  -->
                  <div id="type" class="card-body card-body-cascade" >
                    ...
                    <fieldset class="form-check mb-4" id="typefield"  >
                      <input  name="type" class="type form-check-input"  value="{{$video->type}}" checked  type="checkbox" id="type1">
                      <label class="form-check-label" for="type1" onclick="m();">{{$video->type}}</label>
                    </fieldset>
