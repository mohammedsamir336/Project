...
<div class="container">
      ...
      <section class="my-5">
        ...
        <div class="row">
          ...
          <!-- Grid column -->
          <div class="col-lg-8">
            <form enctype="multipart/form-data" action="{{route('admin.PutVideoInPost')}}" method="post">
                     @csrf
            <!-- if post have video-->
            @if (session('errors'))
           ...
           <!--  card -->
            ...
            <div class="card mb-4 post-title-panel">
              <div class="card-body">
                <div class="md-form mt-1 mb-0">
                  ...
                  <input type="text" name="author" id="form2" class="form-control " value="{{$video->author}}" onfocus=" $(this).attr('disabled', true);" onblur="$(this).attr('disabled',false);">
            ...
            <div class="card mb-4 post-title-panel">
              <div class="card-body">
                <div class="md-form mt-1 mb-0">
                  <input type="url" name="video" id="form4" class="form-control" value="{{$video->video}}" onfocus=" $(this).attr('disabled', true);" onblur="$(this).attr('disabled',false);">
            ...
            <div class="card mb-4 post-title-panel">
              <div class="card-body">
                <div class="md-form mt-1 mb-0">
                  <input type="text" name="title" id="title" class="form-control" value="{{$video->title}}" onfocus=" $(this).attr('disabled', true);" onblur="$(this).attr('disabled',false);" >
              ...
              <!-- Card type -->
                    ...
                    <div class="card-body card-body-cascade" id="Entertainment" >
                      <fieldset class="form-check mb-4" id="typefield11">
                        <input  name="type" class="type form-check-input" checked value="{{$video->type}}" type="checkbox" id="color-11" onchange="$(this).prop( 'checked', true ); ">
                        <label class="form-check-label" for="color-11"  >{{$video->type}}</label>
