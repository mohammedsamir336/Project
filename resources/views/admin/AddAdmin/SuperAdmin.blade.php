        ...
        <div class="auth-box bg-dark  border-secondary" style="position:relative;bottom:100px">
            ...
            <div>
                <div class="text-center p-t-20 p-b-20">
                    ...
                    <span class="db "><img class="rounded-circle hoverable" src="{{asset('img/admin_img/'.auth()->guard('admin')->user()->img)}}" alt="logo" width="50%" /></span>
                    @else
                    <span class="db "><img class="rounded-circle hoverable" src="{{auth()->guard('admin')->user()->img}}" alt="logo" width="35%" /></span>
                    @endif
                </div>
                <!-- Form -->
                    ...
                    <div class="row p-b-30">
                        <div class="col-12">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="name" class="form-control form-control-lg  @error('name') is-invalid @enderror" placeholder="{{ __('Name') }}" aria-label="name" aria-describedby="basic-addon1" value="{{ old('name') }}"
                                  required>
                                @error('name')
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="number" class="form-control form-control-lg @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" placeholder="{{ __('Phone') }}" aria-label="phone" aria-describedby="basic-addon3"
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input id="password-confirm" type="password" name="password_confirmation" class="form-control form-control-lg " placeholder=" {{ __('Confirm Password') }}" aria-label="Password" aria-describedby="basic-addon1"
                                  required>
                            </div>
                    ...
                    <div class="row border-top border-secondary">
                        <div class="col-12">
                            <div class="form-group">
                                <div class="p-t-20">
                                    <button name="signup" class="btn btn-block btn-lg btn-info" type="submit"> {{ __('Sign Up') }}</button>
                                </div>
                            </div>
                        </div>
                    </div>
