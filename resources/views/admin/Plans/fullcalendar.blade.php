@include('admin.layout.header')
    ...
    <script src="{{ asset('adminfolder/dist/js/jquery-ui.min.js') }}"></script>
    <script src="{{ asset('adminfolder/assets/libs/moment/min/moment.min.js') }}"></script>
    <script src="{{ asset('adminfolder/assets/libs/fullcalendar/dist/fullcalendar.min.js') }}"></script>
    <script src="{{ asset('adminfolder/dist/js/pages/calendar/mm.js') }}"></script>
