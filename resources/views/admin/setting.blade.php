...
<title id="title">Admin-Setting</title>
<span id="page_name" style="display:none">Admin-Setting</span>
...
<div class="container-fluid ">
 <div class="row">
    <div class="col-lg-10">
       ...
       <div class="card" style="margin-top:61px;margin-left:51px">
    <!-- Nav tabs -->
...
<!-- Card -->
        <div class="tab-pane p-20" id="photo" role="tabpanel">
            <div class="p-20">
              ...
              <div class="col-lg-4 mb-4" style="margin-left:30px">
                @if ( file_exists('img/admin_img/'.Auth::guard('admin')->user()->img))
                <img  id="admin_img" src="{{asset('img/admin_img/'.auth()->guard('admin')->user()->img)}}" class=" rounded-circle hoverable" height="230" width="250" />
                 @else
                 <img  id="admin_img" src="{{auth()->guard('admin')->user()->img}}" class=" rounded-circle hoverable" height="170" width="190" />
                 @endif
        ...
        <div  style="margin-left:30px">
          ...
          <form action="{{route('admin.change_profile')}}" method="post">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="md-form mb-0">
                        <input type="text" id="form81" class="form-control @error('birth') is-invalid @enderror" name="birth" value="{{old('birth') }}"
                    ...
                    <div class="col-md-6">
                      <div class="md-form mb-0">
                        <input type="url" id="form82" class="form-control @error('website') is-invalid @enderror" name="website" value="{{old('website') }}"
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="md-form mb-0">
                        <input type="text" id="form76" class="form-control @error('facebook') is-invalid @enderror" name="facebook" value="{{old('facebook') }}"
                    ...
                    <div class="col-md-6">
                      <div class="md-form mb-0">
                        <input type="text" id="form77" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{old('phone') }}"
                        placeholder="{{ __('Phone number') }}" onfocus="(this.type='number')"
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <div class="md-form mb-0">
                        <textarea type="text" id="form78" class="md-textarea form-control @error('about') is-invalid @enderror" name="about"
...
$(document).ready(function(){
 ...
 $('#upload_form').on('submit', function(event){
  ...
  $.ajax({
   ...
   {
     /*nav_img and logo for admin img in header blade*/
    $('#nav_img').css('display', 'none');
    $('#logo').html(data.logo);
    $('#logo').css('display', 'block');
    $('#admin_img').css('display', 'none');
