                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <a id="nav_img" class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img id="navimg"
                                  src="{{asset('img/admin_img/'.Auth::guard('admin')->user()->img)}}" alt="admin" class="rounded-circle" height="51" width="51"></a>
                            @else
                            <a id="nav_img" class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img id="navimg"
                                  src="{{Auth::guard('admin')->user()->img}}" alt="admin" class="rounded-circle" height="51" width="51"></a>
                            @endif
