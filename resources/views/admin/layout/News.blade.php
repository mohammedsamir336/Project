      ...
      @foreach ($news as $data)
        <li class="d-flex no-block card-body">
           ...
           <div>
                ...
                <span class="text-muted ml-4" style="position:relative;left:10px" >{{Str::words($data->text, 5, '...')}}</span> <!--Str::limit($data->text, 30, '...')-->

                <div id="collapseTwo{{$data->id}}" class="collapse" aria-labelledby="headingTwo{{$data->id}}" >
                  <div class="card-body">
                    <span><a href="#" class="text-dark" > By: <b>{{$data->news_admins_id()->first()->name}}</a></b></span>
